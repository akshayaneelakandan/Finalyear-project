  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown"><a href="client.jsp">Home </a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="component1.jsp">Application Software</a></li>
            <li><a href="busines1.jsp">Business Software</a></li>
            <li><a href="network1.jsp">Network Software</a></li>
          </ul>
        </li>
		<li class="dropdown">
          <a href="compliant1.jsp" >Provider </a>
		...
		<!--<li><a href="about.html">About Us</a></li>-->
                ...
                <li><a href="clientlogin.jsp">Log out</a></li>
      </ul>
               ...
               <tr><td>Ammyy Admin</td>
				...
				<div class="col-md-5 tes">
					<div class="m_8">
                                            ...
                                            <div class="address">
                                                <form name="fname" action="clientorder" method="Post" onsubmit="return validation();">
