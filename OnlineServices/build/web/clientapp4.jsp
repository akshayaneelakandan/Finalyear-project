...
<%
        ...
        String query="select * from provider where Mobile='"+Mobile+"'";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown"><a href="Platinumlogin.jsp">Home </a></li>
				...
				<div class="col-md-7 map">
				  <div class="map">
                                      <ul class="rslides" id="slider" >                                          
                                            ...
                                            <div class="address">
                                              <table style="margin-top:0px; margin-left:0px;" cellpadding="15"  border="2">
                                            <tr><h5>
                                                <td><b>Name</b></td>
                                                <td><b>Product</b></td>  
                                                <td><b>Company</b></td>
