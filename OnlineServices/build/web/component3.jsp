  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown"><a href="golden.jsp">Home </a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="component3.jsp">Application Software</a></li>
            <li><a href="busines3.jsp">Business Software</a></li>
            <li><a href="network3.jsp">Network Software</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="compliant3.jsp" >Provider </a>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
            <li><a href="individualappointment3.jsp">Appointment Date</a></li>
             <li><a href="Goldenview.jsp">Discount Details</a></li>
            
          </ul>
        </li>
                
		 <li><a href="Report3.jsp">Report</a></li>
		
                <li><a href="goldenlogout.jsp">Log out</a></li>
      </ul>
               ...
               <tr><td>Ammyy Admin</td>
				...
				<div class="col-md-5 tes">
					<div class="m_8">
                                            ...
                                            <div class="address">
                                                <form name="fname" action="goldenorder" method="Post" onsubmit="return validation();">
