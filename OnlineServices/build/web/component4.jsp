  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown"><a href="platinum.jsp">Home </a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="component4.jsp">Application Software</a></li>
            <li><a href="busines4.jsp">Business Software</a></li>
            <li><a href="network4.jsp">Network Software</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="compliant4.jsp" >Provider </a>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
            <li><a href="individualappointment4.jsp">Appointment Date</a></li>
             <li><a href="Platinumview.jsp">Discount Details</a></li>
            
          </ul>
        </li>
                
		 <li><a href="Report4.jsp">Report</a></li>
		
                <li><a href="platinumlogout.jsp">Log out</a></li>
      </ul>
	...
	<div class="main">
      <div class="contact_top">
		<div class="container">
            ...
            <caption><h2>Application Softwares</h2></caption>
            <tr>                
                <th>Name</th>
                <th>Version</th>
                <th>Price</th>
                ...
                <tr>
                    ...
                    <td>2015 v15.0.6125</td>
                    <td>1000</td></tr>
                
                <tr><td>Free Ringtone Maker Portable  </td>
                    <td>2.4.0.2598</td>
                    <td>2000</td></tr></tr>
                                                     
                <tr> <td>LicenseCrawler</td>
                <td>1.47.0.825</td>
                <td>3000</td></tr></tr>
              
                <tr><td>CheatBook-DataBase </td>
                    <td>2009 v1.0   </td>
                    <td>3000</td></tr></tr>
                                                     
                <tr><td>Risingware Exp+ Free Edition </td>
                     <td>3.1.0   </td>
                     <td>6000</td></tr></tr>
                                                     
                 <tr><td>McAfee SuperDAT Update </td>
                     <td>7884    </td>    
                     <td>4000</td></tr></tr>
                </tr>
                <tr><td>PaintStar </td>
                    ...
                    <td>v2047  </td>
                    <td>7000</td></tr></tr>
               <tr><td>Ammyy Admin</td>
                   <td> 3.5    </td>   
                   <td>5000</td></tr></tr>
                </tr>
                <tr><td>Little Fighter </td>
                    <td>2   </td>
                    <td>2000</td></tr></tr>
				...
				<div class="col-md-5 tes">
					<div class="m_8">
                                            ...
                                            <div class="address">
                                                <form name="fname" action="platinumorder" method="Post" onsubmit="return validation();">

                <table style="margin-top:55px; margin-left:0px;" border="1" width="400" height="200" >
                    <thead>
                        <tr>
