 ...
 function validateion()
    {
        var name1 = document.getElementById('uid').value;
               ...
               var pass1 = document.getElementById('pid').value;
                        ...
                        {
                            alert('Password length should be 3 to 10 digits');
                            return false;
                        }
                        return true;
    }
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5 tes">
					...
					<div class="address">
                                            <form method="post" action="clientcheck" onsubmit="return validateion();">
            ...
            <table style="margin-top:0px; margin-left:0px;" border="1" width="300" height="200" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <tr> <td colspan="2">Permission User!... <a href="clientForgetpasswd.jsp">Click Here</a></td>
                    </tr>
                </tbody>
            </table>
