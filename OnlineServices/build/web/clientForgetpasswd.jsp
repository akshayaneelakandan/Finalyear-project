    ...
    function validation()
    {
        var name1 = document.getElementById('uid').value;
                        ...
                        else if (!name11)
                        {
                         ...
                         var mml = document.getElementById("mid").value;
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5 tes">
					...
					<div class="address">
                                            <form name="fname" method="post" action="clientlogagain.jsp" onsubmit="return validation();">
            ...
            <table style="margin-top:0px; margin-left:0px;" border="1" width="300" height="200" >
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Mobile </td>
                        <td><input type="text" name="mobile" id="mid"/></td>
                    </tr>
                    <tr>
