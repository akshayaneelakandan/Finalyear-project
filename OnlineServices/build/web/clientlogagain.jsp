...
<%@page import="Service.userforget" %>
...
<%
       ...
       // String name=request.getParameter("uname");
        String query="select clientname,mobilenumber,password from permission where mobilenumber='"+mobile+"'";
			...
			<div class="row">
				...
				<div class="col-md-5 tes">
					<div class="m_8">
                                    ...
                                    %>
                                        <tr>
                                            <td><%= i.getString("clientname")%></td>
                                            <td><%= i.getString("mobilenumber")%></td>
                                            <td><%= i.getString("password")%></td>
                                            <%   
                                        }
                                        num++;
                                        i.close();
                                        ...
                                        <a href="clientlogin.jsp">You want login click here</a>
						</ul>
			  		</div>
				 </div>
				</div>
